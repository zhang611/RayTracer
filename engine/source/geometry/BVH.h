...
class BVHNode : public Hittable {
   ...
   public:
    BVHNode(std::shared_ptr<Hittable> left,
...
class BVHAccel {
   public:
    ...
    static std::shared_ptr<BVHNode> Build(
        const Scene& scene, SplitMethod splitMethod = SplitMethod::NAIVE);
    static std::shared_ptr<BVHNode> recursiveBuild(
