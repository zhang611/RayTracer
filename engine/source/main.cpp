...
void DisplayTexture(const RayTracer::Texture *pTex) {
    ...
    glRasterPos2f(-1, 1);
    glPixelZoom(1, -1);  // flip the image
    glDrawPixels(pTex->GetWidth(), pTex->GetHeight(), GL_RGBA, GL_UNSIGNED_BYTE,
                 pTex->GetData());
}
...
int main() {
    ...
    switch (9) {
        case 1:
            get_random_sphere_world(camera, world);
            break;
        case 2:
            get_two_sphere_world(camera, world);
            break;
        case 3:
            earth(camera, world);
            break;
        case 4:
            perlin_sphere(camera, world);
            break;
        case 5:
            quads(camera, world);
            break;
        case 6:
            simple_light(camera, world);
            break;
        case 7:
            cornell_box(camera, world);
            break;
        case 8:
            cornell_smoke(camera, world);
            break;
        case 9:
            final_scene(camera, world);
            break;
        case 10:
            cornell_box_sphere(camera, world);
            break;
        case 11:
            triangle(camera, world);
            break;
        case 12:
            mesh(camera, world);
            break;
...
void get_random_sphere_world(RayTracer::Camera &cam, RayTracer::Scene &world) {
    ...
    auto checker = std::make_shared<TexChecker>(0.3f, Vector3(0.2f, 0.3f, 0.1f),
                                                Vector3(0.9f, 0.8f, 0.9f));
    auto material_ground = std::make_shared<RayTracer::Lambert>(checker);
    world.add(std::make_shared<Sphere>(Vector3(0.0f, -1000.0f, 0.0f), 1000.0f,
                                       material_ground));

    auto material_center =
        std::make_shared<RayTracer::Lambert>(Vector3(0.7f, 0.3f, 0.3f));
    // auto metal_left = std::make_shared<RayTracer::D>(Vector3(0.8f, 0.8f,
    // 0.8f), 0.3f);
    auto d_left = std::make_shared<RayTracer::Dielectric>(0.8f);
    auto metal_right =
        std::make_shared<RayTracer::Metal>(Vector3(0.8f, 0.6f, 0.2f), 0.1f);
...
void get_two_sphere_world(RayTracer::Camera &cam, RayTracer::Scene &world) {
    ...
    auto checker = make_shared<TexChecker>(0.8f, Vector3(.2f, .3f, .1f),
                                           Vector3(.9f, .9f, .9f));

    world.add(make_shared<Sphere>(Vector3(0.0f, -10.0f, 0.0f), 10.0f,
                                  make_shared<Lambert>(checker)));
    world.add(make_shared<Sphere>(Vector3(0.0f, 10.0f, 0.0f), 10.0f,
                                  make_shared<Lambert>(checker)));
}
...
void earth(RayTracer::Camera &cam, RayTracer::Scene &world) {
    ...
    auto earth_surface = make_shared<Lambert>(
        make_shared<ImageTexture>("asset/images/earthmap.jpg"));
    auto globe =
        make_shared<Sphere>(Vector3(0.0f, 0.0f, 0.0f), 2.0f, earth_surface);
    world.add(globe);
}
...
void perlin_sphere(RayTracer::Camera &cam, RayTracer::Scene &world) {
    ...
    world.add(make_shared<Sphere>(Vector3(0.0f, -1000.0f, 0.0f), 1000.0f,
                                  make_shared<Lambert>(pertext)));
    world.add(make_shared<Sphere>(Vector3(0.0f, 2.0f, 0.0f), 2.0f,
                                  make_shared<Lambert>(pertext)));
}
...
void quads(RayTracer::Camera &cam, RayTracer::Scene &world) {
    ...
    // Quads
    world.add(make_shared<Quad>(Vector3(-3.f, -2.f, -5.f),
                                Vector3(0.f, 0.f, 4.f), Vector3(0.f, 4.f, 0.f),
                                left_red));
    world.add(make_shared<Quad>(Vector3(-2.f, -2.f, 0.f),
                                Vector3(4.f, 0.f, 0.f), Vector3(0.f, 4.f, 0.f),
                                back_green));
    world.add(make_shared<Quad>(Vector3(3.f, -2.f, -1.f),
                                Vector3(0.f, 0.f, -4.f), Vector3(0.f, 4.f, 0.f),
                                right_blue));
    world.add(make_shared<Quad>(Vector3(-2.f, 3.f, -1.f),
                                Vector3(4.f, 0.f, 0.f), Vector3(0.f, 0.f, -4.f),
                                upper_orange));
    world.add(make_shared<Quad>(Vector3(-2.f, -3.f, -5.f),
                                Vector3(4.f, 0.f, 0.f), Vector3(0.f, 0.f, 4.f),
                                lower_teal));
}
...
void simple_light(RayTracer::Camera &cam, RayTracer::Scene &world) {
    ...
    world.add(make_shared<Quad>(Vector3(3.0f, 1.0f, 2.0f),
                                Vector3(0.0f, 2.0f, 0.0f),
                                Vector3(2.0f, 0.0f, 0.0f), difflight));
}
...
void cornell_box(RayTracer::Camera &cam, RayTracer::Scene &world) {
    ...
    // create scene
    // walls
    world.add(make_shared<Quad>(Vector3(555.0f, 0.0f, 0.f),
                                Vector3(0.0f, 0.0f, -555.0f),
                                Vector3(0.0f, 555.0f, 0.0f), green));
    world.add(make_shared<Quad>(Vector3(0.0f, 0.0f, 0.0f),
                                Vector3(0.0f, 0.0f, -555.0f),
                                Vector3(0.0f, 555.0f, 0.0f), red));
    world.add(make_shared<Quad>(Vector3(0.0f, 0.0f, 0.0f),
                                Vector3(555.0f, 0.0f, 0.0f),
                                Vector3(0.0f, 0.0f, -555.0f), white));
    world.add(make_shared<Quad>(Vector3(555.0f, 555.0f, -555.0f),
                                Vector3(-555.0f, 0.0f, 0.0f),
                                Vector3(0.0f, 0.0f, 555.0f), white));
    world.add(make_shared<Quad>(Vector3(0.0f, 0.0f, -555.0f),
                                Vector3(555.0f, 0.0f, 0.0f),
                                Vector3(0.0f, 555.0f, 0.0f), white));

    // lights
    auto _light = make_shared<Quad>(Vector3(343.0f, 554.0f, -332.0f),
                                    Vector3(0.0f, 0.0f, 105.0f),
                                    Vector3(-130.0f, 0.0f, 0.0f), light);
    world.add(_light);
    Lights::lights->add(_light);
    // box

    std::shared_ptr<RayTracer::Hittable> box1 = make_shared<Box>(
        Vector3(0.0f, 0.0f, 0.0f), Vector3(165.0f, 165.0f, 165.0f), white);
    box1 = Translation::Translate(
        Rotation::Rotate(box1, Vector3(0.0f, 18.0f, 0.0f)),
        Vector3(130.0f + 82.5f, 82.5f, -65.0f - 82.5f));
    world.add(box1);
    std::shared_ptr<RayTracer::Hittable> box2 = make_shared<Box>(
        Vector3(0.0f, 0.0f, 0.0f), Vector3(165.0f, 330.0f, 165.0f), aluminum);
    box2 = Translation::Translate(
        Rotation::Rotate(box2, Vector3(0.0f, -15.0f, 0.0f)),
        Vector3(265.0f + 82.5f, 165.0f, -295.0f - 82.5f));
    world.add(box2);
}
...
void cornell_smoke(RayTracer::Camera &cam, RayTracer::Scene &world) {
    ...
    // lights
    world.add(make_shared<Quad>(Vector3(343.0f, 554.0f, -332.0f),
                                Vector3(0.0f, 0.0f, 105.0f),
                                Vector3(-130.0f, 0.0f, 0.0f), light));
    ...
    std::shared_ptr<RayTracer::Hittable> box2 = make_shared<Box>(
        Vector3(0.0f, 0.0f, 0.0f), Vector3(165.0f, 330.0f, 165.0f), white);
    box2 = Translation::Translate(
        Rotation::Rotate(box2, Vector3(0.0f, -15.0f, 0.0f)),
        Vector3(265.0f + 82.5f, 165.0f, -295.0f - 82.5f));

    world.add(
        make_shared<ConstantMedium>(box1, 0.01f, Vector3(0.0f, 0.0f, 0.0f)));
    world.add(
        make_shared<ConstantMedium>(box2, 0.01f, Vector3(1.0f, 1.0f, 1.0f)));
}
...
void final_scene(RayTracer::Camera &cam, RayTracer::Scene &world) {
    ...
    for (int i = 0; i < boxes_per_side; i++) {
        for (int j = 0; j < boxes_per_side; j++) {
            ...
            Vector3 center =
                Vector3(0.5f * (x0 + x1), 0.5f * (y0 + y1), 0.5f * (z0 + z1));
    ...
    world.add(make_shared<Quad>(Vector3(123.0f, 554.0f, -147.0f),
                                Vector3(300.0f, 0.0f, 0.0f),
                                Vector3(0.0f, 0.0f, -265.0f), light));
    ...
    world.add(make_shared<Sphere>(Vector3(260.f, 150.f, -45.f), 50.f,
                                  make_shared<Dielectric>(1.5f)));
    world.add(make_shared<Sphere>(
        Vector3(0.f, 150.f, -145.f), 50.f,
        make_shared<Metal>(Vector3(0.8f, 0.8f, 0.9f), 1.0f)));

    auto boundary = make_shared<Sphere>(Vector3(360.0f, 150.0f, -145.0f), 70.0f,
                                        make_shared<Dielectric>(1.5f));
    world.add(boundary);
    world.add(
        make_shared<ConstantMedium>(boundary, 0.2f, Vector3(0.2f, 0.4f, 0.9f)));
    boundary = make_shared<Sphere>(Vector3(0.0f, 0.0f, 0.0f), 5000.0f,
                                   make_shared<Dielectric>(1.5f));
    world.add(
        make_shared<ConstantMedium>(boundary, .0001f, Vector3(1.f, 1.f, 1.f)));

    auto emat = make_shared<Lambert>(
        make_shared<ImageTexture>("asset/images/earthmap.jpg"));
    world.add(make_shared<Sphere>(Vector3(400.f, 200.f, -400.f), 100.f, emat));
    auto pertext = make_shared<NoiseTexture>(0.1f);
    world.add(make_shared<Sphere>(Vector3(220.f, 280.f, -300.f), 80.f,
                                  make_shared<Lambert>(pertext)));
    ...
    for (int j = 0; j < ns; j++) {
        subScene2->add(
            make_shared<Sphere>(Vector3::random(0.0f, 165.0f), 10.0f, white));
    }
    subScene2->BuildBVH();

    world.add(Translation::Translate(
        Rotation::Rotate(subScene2, Vector3(0.0f, -15.f, 0.0f)),
        Vector3(-100.0f, 270, -395.0f)));
}
...
void cornell_box_sphere(RayTracer::Camera &cam, RayTracer::Scene &world) {
    ...
    // std::shared_ptr<RayTracer::Hittable> box1 =
    // make_shared<Box>(Vector3(0.0f, 0.0f, 0.0f), Vector3(165.0f, 165.0f,
    // 165.0f), white); box1 = Translation::Translate(Rotation::Rotate(box1,
    // Vector3(0.0f, 18.0f, 0.0f)), Vector3(130.0f+ 82.5f, 82.5f,
    // -65.0f-82.5f)); world.add(box1);

    auto Glass = make_shared<Dielectric>(1.5f);
    auto glass =
        make_shared<Sphere>(Vector3(190.0f, 90.0f, -190.0f), 90.0f, Glass);
    world.add(glass);
...
void triangle(RayTracer::Camera &cam, RayTracer::Scene &world) {
    ...
    // left
    world.add(make_shared<Triangle>(Vector3(-3.f, 2.f, -1.f),
                                    Vector3(-3.f, 2.f, -5.f),
                                    Vector3(-3.f, -2.f, -5.f), left_red));
    world.add(make_shared<Triangle>(Vector3(-3.f, 2.f, -1.f),
                                    Vector3(-3.f, -2.f, -1.f),
                                    Vector3(-3.f, -2.f, -5.f), back_green));

    world.add(make_shared<Triangle>(Vector3(-2.f, -2.f, 0.f),
                                    Vector3(2.f, -2.f, 0.f),
                                    Vector3(-2.f, 2.f, 0.f), back_green));
    world.add(make_shared<Triangle>(Vector3(2.f, 2.f, 0.f),
                                    Vector3(2.f, -2.f, 0.f),
                                    Vector3(-2.f, 2.f, 0.f), right_blue));

    world.add(make_shared<Triangle>(Vector3(3.f, 2.f, -1.f),
                                    Vector3(3.f, 2.f, -5.f),
                                    Vector3(3.f, -2.f, -5.f), right_blue));
    world.add(make_shared<Triangle>(Vector3(3.f, 2.f, -1.f),
                                    Vector3(3.f, -2.f, -1.f),
                                    Vector3(3.f, -2.f, -5.f), lower_teal));

    world.add(make_shared<Triangle>(Vector3(-2.f, 3.f, -5.f),
                                    Vector3(2.f, 3.f, -1.f),
                                    Vector3(2.f, 3.f, -5.f), upper_orange));
    world.add(make_shared<Triangle>(Vector3(-2.f, 3.f, -5.f),
                                    Vector3(2.f, 3.f, -1.f),
                                    Vector3(-2.f, 3.f, -1.f), left_red));

    world.add(make_shared<Triangle>(Vector3(-2.f, -3.f, -5.f),
                                    Vector3(2.f, -3.f, -1.f),
                                    Vector3(-2.f, -3.f, -1.f), lower_teal));
    world.add(make_shared<Triangle>(Vector3(-2.f, -3.f, -5.f),
                                    Vector3(2.f, -3.f, -1.f),
                                    Vector3(2.f, -3.f, -5.f), upper_orange));
}
...
void mesh(RayTracer::Camera &cam, RayTracer::Scene &world) {
    ...
    auto mesh =
        make_shared<MeshTriangle>("asset/models/bunny/bunny.obj", diffuse);
    ...
    auto ground = make_shared<Sphere>(Vector3(0.0f, -1000.0f, 0.0f), 1000.0f,
                                      material_ground);
    world.add(ground);
}